...
// 1. Inisialisasi Toko berdasarkan Subdomain
export async function initTenantSession() {
  try {
    ...
    if (!result.success) {
      ...
      document.body.innerHTML = `
        <div class="h-screen flex flex-col items-center justify-center bg-slate-100 p-6 text-center font-sans">
          ...
          <span class="text-xs text-slate-400">Pastikan subdomain yang Anda tuju sudah aktif.</span>
        </div>
      `;
      return false;
    }
    ...
    // Perbarui nama toko di header dan sidebar secara dinamis
